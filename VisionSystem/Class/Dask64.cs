...
/*---------------------------------------------------------------------------*/
    ...
    [DllImport("PCI-Dask64.dll")]
    public static extern short AI_9524_GetEOCEvent (ushort CardNumber, ushort Group, out long hEvent);
    [DllImport("PCI-Dask64.dll")]
    ...
    [DllImport("PCI-Dask64.dll")]
    public static extern short AI_EventCallBack_x64 (ushort CardNumber, ushort mode, ushort EventType, MulticastDelegate callbackAddr);
    [DllImport("PCI-Dask64.dll")]
...
/*---------------------------------------------------------------------------*/
    ...
    [DllImport("PCI-Dask64.dll")]
    public static extern short AO_EventCallBack_x64 (ushort CardNumber, ushort mode, ushort EventType, MulticastDelegate callbackAddr);
    [DllImport("PCI-Dask64.dll")]
...
/*---------------------------------------------------------------------------*/
    ...
    [DllImport("PCI-Dask64.dll")]
    public static extern short DI_EventCallBack_x64 (ushort CardNumber, short mode, short EventType, MulticastDelegate callbackAddr);
    [DllImport("PCI-Dask64.dll")]
...
/*---------------------------------------------------------------------------*/
    ...
    [DllImport("PCI-Dask64.dll")]
    public static extern short DO_EventCallBack_x64 (ushort CardNumber, short mode, short EventType, MulticastDelegate callbackAddr);
    [DllImport("PCI-Dask64.dll")]
...
/*---------------------------------------------------------------------------*/
    ...
    [DllImport("PCI-Dask64.dll")]
    public static extern short DIO_SetCOSInterrupt32 (ushort CardNumber, byte Port, uint ctl, out long hEvent, bool ManualReset);
    [DllImport("PCI-Dask64.dll")]
    ...
    [DllImport("PCI-Dask64.dll")]
    public static extern short DIO_PMControl (ushort CardNumber, ushort Port, ushort PM_Start, out long hEvent, bool ManualReset);
    [DllImport("PCI-Dask64.dll")]
    public static extern short DIO_SetPMInterrupt32 (ushort CardNumber, ushort Port, uint Ctrl, uint Pattern1, uint Pattern2, out long hEvent, bool ManualReset);
    [DllImport("PCI-Dask64.dll")]
...
/*---------------------------------------------------------------------------*/
    ...
    [DllImport("PCI-Dask64.dll")]
    public static extern short GPTC_EventCallBack_x64 (ushort CardNumber, ushort Enabled, ushort EventType, MulticastDelegate callbackAddr);
    [DllImport("PCI-Dask64.dll")]
    ...
    [DllImport("PCI-Dask64.dll")]
    public static extern short GPTC_9524_GetTimerEvent (ushort CardNumber, ushort GCtr, out long hEvent);
    [DllImport("PCI-Dask64.dll")]
    public static extern short WDT_Setup (ushort CardNumber, ushort Ctr, float ovflowSec, out float actualSec, out long hEvent);
    [DllImport("PCI-Dask64.dll")]
...
/*---------------------------------------------------------------------------*/
    [DllImport("PCI-Dask64.dll")]
    public static extern short AI_GetEvent (ushort CardNumber, out long hEvent);
    [DllImport("PCI-Dask64.dll")]
    public static extern short AO_GetEvent (ushort CardNumber, out long hEvent);
    [DllImport("PCI-Dask64.dll")]
    public static extern short DI_GetEvent (ushort CardNumber, out long hEvent);
    [DllImport("PCI-Dask64.dll")]
    public static extern short DO_GetEvent (ushort CardNumber, out long hEvent);
/*---------------------------------------------------------------------------*/
    [DllImport("PCI-Dask64.dll")]
